...
<head>
  ...
  <title>Tujau Drinks & Liquor Store</title>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Product Price</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="components-alerts.html">
              <i class="bi bi-circle"></i><span>Retail Products</span>
            </a>
          </li>
          <li>
            <a href="components-accordion.html">
              <i class="bi bi-circle"></i><span>Wholesale Products</span>
            </a>
          </li>
          ...
          <li>
            <a href="components-tooltips.html">
              <i class="bi bi-circle"></i><span>Price Calculations</span>
            </a>
          </li>
        </ul>
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.html">
              <i class="bi bi-circle"></i><span>Retail Sales Data</span>
            </a>
          </li>
          <li>
            <a href="forms-elements.html">
              <i class="bi bi-circle"></i><span>Wholesales Data</span>
            </a>
          </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Sales Calculations</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="icons-bootstrap.html">
              <i class="bi bi-circle"></i><span>Retail Sales Calculations</span>
            </a>
          </li>
          <li>
            <a href="icons-bootstrap.html">
              <i class="bi bi-circle"></i><span>Wholesales Calculations</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-gem"></i><span>Customers Database</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
...
?>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Developed  by <a href="https://fmpiza.github.io/webfridolin">Fridolin</a>
    </div>
  </footer><!-- End Footer -->
